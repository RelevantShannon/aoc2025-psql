...
WITH RECURSIVE starting_count AS (
    SELECT
                ...
                FROM
                    ...
                    (
                        ...
                        neighbor_counts AS (
                            ...
                            WHERE
                                COALESCE(neighbor_counts.neighbor_papers, 0) >= 4),
                            ...
                            paper_stats AS (
                                ...
                                FROM
                                    ...
                                    paper_stats
                                WHERE
                                    paper_stats.paper_count != new_board.old_paper_count))
                    SELECT
